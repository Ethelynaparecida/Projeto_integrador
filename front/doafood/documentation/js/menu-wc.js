                ...
                <li class="chapter">
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-a45afc6b80844ed0064adc0803846a24"' : 'data-target="#xs-components-links-module-AppModule-a45afc6b80844ed0064adc0803846a24"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-a45afc6b80844ed0064adc0803846a24"' :
                                            'id="xs-components-links-module-AppModule-a45afc6b80844ed0064adc0803846a24"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/ComunidadeComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ComunidadeComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/ComunidadeDeleteComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ComunidadeDeleteComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/ComunidadeEditComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ComunidadeEditComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/ComunidadeViewComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ComunidadeViewComponent</a>
                                            </li>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            <li class="link">
                                <a href="classes/Comunidade.html" data-type="entity-link">Comunidade</a>
                            </li>
                            <li class="link">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/ComunidadeService.html" data-type="entity-link">ComunidadeService</a>
                                </li>
                                <li class="link">
